...
namespace Bengesht.WsClientCat
{
    public class WsClientStart : WsClientComponent
    {
        ...
        private void documentServerOnDocumentClosed(object sender, GH_Document doc)
        {
        ...
        private void subscribeToEvents()
        {
            if (!this.isSubscribedToEvents)
            {
                ...
                if (this.ghDocument != null)
                {
                    ...
                    this.ghDocument.ContextChanged += documentServerOnDocumentClosed;
        ...
        private void documentServerOnDocumentClosed(object sender, GH_DocContextEventArgs e)
        {
            if (this.ghDocument != null)
            {
                this.disconnect();
